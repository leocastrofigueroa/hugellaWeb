  ...
  useEffect(() => {
    ...
    const comprobarImagenes = async () => {
      ...
      for (const nombre of posiblesImagenes) {
        const ruta =
          `/imgHugella/productos/${producto.carpeta}/${nombre}`;
      ...
      if (!cancelado) {
        ...
        if (imagenesValidas.length > 0) {
          setImagenPrincipal(imagenesValidas[0]);
        } else {
          setImagenPrincipal("");
        }
      }
    ...
    <section className="max-w-7xl mx-auto px-6 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mt-10">
            ...
            <div className="flex gap-4 mt-6 justify-center flex-wrap">
              ...
              {imagenes.map((imagen, index) => (
                <button
                  ...
                  className={`w-20 h-20 bg-white rounded-xl overflow-hidden border-2 transition ${
        ...
        <div>
          ...
          {producto.precio > 0 && (
            <p className="text-5xl font-extrabold text-blue-700 mt-8">
          ...
          <a
            ...
            className="inline-block mt-10 bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-xl font-bold transition"
          >
